...
/**
 * Lightweight result type for data operations. [Success] may carry a [fromCache]
 * flag so the UI can surface a gentle "showing offline copy" note without treating
 * it as an error.
 */
